...
public class TestSyscoOnline extends CommonSysco {
	...
	/*
	 * @Test(priority = 27) public void PilotHouse_Sysco() throws
	 * InterruptedException, MessagingException {
	 * 
	 * System.out.println("27, PilotHouse_Sysco");
	 * 
	 * // check if login is success startSysco(driver, "BDpilothouse",
	 * "016695882", "marina100");
	 * 
	 * //sendMail SendMailSSL.sendMailAction("Sysco - Offline GP",
	 * "Pilot House Marina"); }
	 */
